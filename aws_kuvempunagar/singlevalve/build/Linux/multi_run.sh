...
#./epanet_wateropt 0 ../../Input_Files/Kabini_zero_demand_without_res_reduced1.inp ../../Input_Files/Tank_Demand_kabini_withoutres_reduced.csv ../../Input_Files/joblist.txt 0 23 1 75 500 1 0.5;
#./epanet_wateropt 0 ../../Input_Files/Kabini_zero_demand_without_res1.inp ../../Input_Files/Tank_Demand_kabini_withoutres.csv ../../Input_Files/joblist.txt 0 23 1 75 500 1 0.5;
...
./epanet_wateropt 2 ../../Input_Files/Kabini_without_res2.inp ../../Input_Files/Tank_Demand_kabini_withoutres.csv ../../result/Job-Output.csv ../../result/tank_1.csv ../../result/valve_1.csv;
